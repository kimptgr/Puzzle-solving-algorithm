...
if __name__ == "__main__":
    ...
    PUZZLE_16 = [
        [EMPTY, EMPTY, MELON, EMPTY, MELON, EMPTY, EMPTY, EMPTY],
        [EMPTY, BANANA, EMPTY, EMPTY, EMPTY, EMPTY, APPLE, EMPTY],
        [EMPTY, EMPTY, EMPTY, GRAPS, APPLE, EMPTY, EMPTY, APPLE],
        [APPLE, EMPTY, BANANA, EMPTY, EMPTY, MELON, EMPTY, EMPTY],
        [EMPTY, EMPTY, GRAPS, EMPTY, EMPTY, GRAPS, EMPTY, MELON],
        [BANANA, EMPTY, EMPTY, MELON, BANANA, EMPTY, EMPTY, EMPTY],
        [EMPTY, MELON, EMPTY, EMPTY, EMPTY, EMPTY, APPLE, EMPTY],
        [EMPTY, EMPTY, EMPTY, GRAPS, EMPTY, BANANA, EMPTY, EMPTY]
    ]

    PUZZLE_17 = [
        [EMPTY, GRAPS, MELON, EMPTY, MELON, EMPTY, GRAPS, EMPTY],
        [GRAPS, EMPTY, EMPTY, APPLE, EMPTY, BANANA, MELON, APPLE],
        [EMPTY, BANANA, APPLE, EMPTY, EMPTY, MELON, EMPTY, GRAPS],
        [EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, APPLE, EMPTY],
        [EMPTY, APPLE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],
        [GRAPS, EMPTY, MELON, EMPTY, EMPTY, BANANA, APPLE, EMPTY],
        [BANANA, EMPTY, GRAPS, EMPTY, MELON, EMPTY, MELON, APPLE],
        [EMPTY, GRAPS, EMPTY, EMPTY, EMPTY, MELON, GRAPS, EMPTY],
    ]

    PUZZLE_18 = [
        [EMPTY, BANANA, EMPTY, EMPTY, GRAPS, EMPTY, EMPTY, GRAPS],
        [GRAPS, EMPTY, EMPTY, GRAPS, EMPTY, EMPTY, APPLE, EMPTY],
        [EMPTY, EMPTY, MELON, EMPTY, EMPTY, MELON, EMPTY, EMPTY],
        [EMPTY, MELON, EMPTY, EMPTY, APPLE, EMPTY, EMPTY, APPLE],
        [APPLE, EMPTY, EMPTY, MELON, EMPTY, EMPTY, APPLE, EMPTY],
        [EMPTY, EMPTY, APPLE, EMPTY, EMPTY, APPLE, EMPTY, EMPTY],
        [EMPTY, APPLE, EMPTY, EMPTY, GRAPS, EMPTY, EMPTY, APPLE],
        [GRAPS, EMPTY, EMPTY, MELON, EMPTY, EMPTY, BANANA, EMPTY],
    ]
    ...
    PUZZLE_22 = [
        [APPLE, EMPTY, EMPTY, EMPTY, EMPTY, BANANA, EMPTY, EMPTY],
        [EMPTY, GRAPS, EMPTY, EMPTY, APPLE, EMPTY, EMPTY, EMPTY],
        [EMPTY, EMPTY, BANANA, EMPTY, EMPTY, BANANA, EMPTY, EMPTY],
        [MELON, EMPTY, EMPTY, MELON, EMPTY, EMPTY, BANANA, EMPTY],
        [EMPTY, APPLE, EMPTY, EMPTY, APPLE, EMPTY, EMPTY, MELON],
        [EMPTY, EMPTY, BANANA, EMPTY, EMPTY, GRAPS, EMPTY, EMPTY],
        [APPLE, EMPTY, EMPTY, MELON, EMPTY, EMPTY, BANANA, EMPTY],
        [EMPTY, EMPTY, MELON, EMPTY, EMPTY, EMPTY, EMPTY, MELON],
    ]
